...
-- CreateEnum
CREATE TYPE "Department" AS ENUM ('RESEARCH', 'RECRUITMENT', 'FINANCE');
...
-- CreateTable
CREATE TABLE "company_status_multi_select" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "company_status_multi_select_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "email_categorizations" (
    ...
    "sender_embedding" vector(1536),
    "receiver_embedding" vector(1536),
    "subject_embedding" vector(1536),
    "body_embedding" vector(1536),

    CONSTRAINT "email_categorizations_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "company_status_multi_select_key_key" ON "company_status_multi_select"("key");

-- CreateIndex
CREATE UNIQUE INDEX "company_status_multi_select_value_key" ON "company_status_multi_select"("value");

-- CreateIndex
CREATE INDEX "company_status_multi_select_field_display_name_idx" ON "company_status_multi_select"("field_display_name");

-- CreateIndex
CREATE INDEX "company_status_multi_select_value_idx" ON "company_status_multi_select"("value");

-- CreateIndex
CREATE INDEX "company_status_multi_select_color_idx" ON "company_status_multi_select"("color");
...
-- CreateIndex
CREATE UNIQUE INDEX "email_categorizations_message_id_key" ON "email_categorizations"("message_id");

-- CreateIndex
CREATE INDEX "email_categorizations_department_idx" ON "email_categorizations"("department");

-- CreateIndex
CREATE INDEX "email_categorizations_message_id_idx" ON "email_categorizations"("message_id");
...
-- AddForeignKey
ALTER TABLE "companies" ADD CONSTRAINT "companies_status_fkey" FOREIGN KEY ("status") REFERENCES "company_status_multi_select"("value") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "interviews" ADD CONSTRAINT "interviews_feedback_fkey" FOREIGN KEY ("feedback") REFERENCES "interview_feedbacks"("value") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "email_categorizations" ADD CONSTRAINT "email_categorizations_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "messages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
