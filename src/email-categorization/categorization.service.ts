...
export class CategorizationService {
    ...
    public processMessage = async (message: IMessage) => {
        ...
        try {
            ...
            this.logger.log(`Determined departments: ${departments.join(', ') || 'none'}`);
            ...
            const existingMetaData = message.meta_data && typeof message.meta_data === 'object' && !Array.isArray(message.meta_data)
            ...
            if (departments.length > 0) {
                ...
                this.logger.warn(`Categorization failed for email: ${message.sender_email}`);
